 ...
 */
 ...
 define(['N/search', 'N/record', './Third Parties/lodash.min.js', 'N/task', 'N/format'], function (search, record, lodash, task, format) {
    ...
    function logicBlockOrderData(salesOrderID){
        if(salesOrderID){
            let logicblockOrderFields = search.lookupFields({
                ...
                id: salesOrderID,
                columns: ["custbody_bsp_isg_lb_order_number", "custbody_bsp_isg_lb_payment_method", "custbody_bsp_isg_lb_purchase_order_num"]
            });
            if(logicblockOrderFields && logicblockOrderFields.custbody_bsp_isg_lb_order_number){
