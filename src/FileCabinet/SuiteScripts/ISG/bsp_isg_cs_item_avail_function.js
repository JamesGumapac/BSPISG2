 ...
 */
define(['N/https', 'N/url', 'N/xml', './Lib/xmlTojson.js'],
    /**
     * @param{https} https
     * @param{url} url
     * @param{xml} xml
     */
    function (https, url, xml, xmlToJson) {
        ...
        function openSuitelet() {
            ...
            stSuiteletUrl = stSuiteletUrl
            window.open(stSuiteletUrl, 'Check Item Available Stock', 'width=1400,height=900');
            return;
